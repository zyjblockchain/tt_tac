...
![](https://github.com/zyjblockchain/tt_tac/utils/eth-watcher/workflows/Go/badge.svg)
...
Run `go get github.com/zyjblockchain/tt_tac/utils/eth-watcher`
...
```shell
docker run zyjblockchain/tt_tac/utilsio/eth-watcher:master /bin/eth-watcher help
...
```shell
docker run zyjblockchain/tt_tac/utilsio/eth-watcher:master /bin/eth-watcher new-block-number
...
```shell
docker run zyjblockchain/tt_tac/utilsio/eth-watcher:master /bin/eth-watcher usdt-transfer
...
```shell
docker run zyjblockchain/tt_tac/utilsio/eth-watcher:master /bin/eth-watcher contract-event-listener \
    --block-backoff 100 \
